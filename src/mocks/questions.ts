...
export const questions : Question[] = [
    {
      "theme": "video-game",
      "question": "In which video game do players compete in the Battle Royale mode to be the last person standing on an island?",
      "options": [
        { "id": 0, "text": "Fortnite" },
    ...
    {
      "theme": "video-game",
      "question": "Which video game features a space marine known as Doomguy who fights demons from Hell?",
      "options": [
        { "id": 0, "text": "Halo" },
        { "id": 1, "text": "Doom" },
        { "id": 2, "text": "Quake" },
    ...
    {
      "theme": "video-game",
      "question": "In 'Overwatch', which character is known for the catchphrase 'It's high noon'?",
      "options": [
        { "id": 0, "text": "Tracer" },
        { "id": 1, "text": "Reaper" },
        { "id": 2, "text": "McCree" },
    ...
    {
      "theme": "video-game",
      "question": "What is the name of the city where the game 'BioShock' takes place?",
      "options": [
        { "id": 0, "text": "Rapture" },
        { "id": 1, "text": "Columbia" },
        { "id": 2, "text": "Midgar" },
    ...
    {
      "theme": "video-game",
      "question": "In which game do you play as Geralt of Rivia, a monster hunter?",
      "options": [
    ...
    {
      "theme": "cinema",
      "question": "Which movie features a giant ship sinking after hitting an iceberg?",
      "options": [
        { "id": 0, "text": "Poseidon" },
        { "id": 1, "text": "Titanic" },
    ...
    {
      "theme": "cinema",
      "question": "Which actor played the character of Jack Sparrow in the 'Pirates of the Caribbean' series?",
      "options": [
    ...
    {
      "theme": "cinema",
      "question": "In which movie does the character 'Forrest Gump' say, 'Life is like a box of chocolates'?",
      "options": [
        { "id": 0, "text": "Cast Away" },
    ...
    {
      "theme": "cinema",
      "question": "Which movie features a group of friends on a quest to find a lost treasure and save their homes from foreclosure?",
      "options": [
